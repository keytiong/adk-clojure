...
Action: Invoke the academic_websearch_agent/tool.
...
Suggest Future Research Directions (Using academic_newresearch_agent):
...
Action: Invoke the academic_newresearch_agent/tool.
Inputs to Tool:
